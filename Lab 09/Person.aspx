<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Person.aspx.cs" Inherits="Lab_09.Person" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="form-row">
            ...
            <div class="col-md-6 mb-3">
                <asp:Label ID="Label5" runat="server" Text="Direccion" AssociatedControlID="txtDireccion"></asp:Label>
        ...
        <div class="form-group">
            <div class="form-check">
                ...
                <asp:Label ID="Label6" runat="server" Text="Aceptar los terminos y condiciones" AssociatedControlID="CheckBox1"></asp:Label>
            </div>
        </div>
